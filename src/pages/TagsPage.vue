...
const IconAssetDriving = `<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M18.6309 4.9389L4.14673 11.1464L9.52655 14.0432Z" fill-opacity="0.6"/><path d="M18.6294 4.94063L12.4219 19.8386L9.52509 14.0449Z"/></svg>`
        ...
        <div class="ds-example-card">
          ...
          <div class="ds-example-card__body">
            <div class="ds-list-row">
              ...
              <AppTag type="success">
                <template #icon><span v-html="IconAssetDriving" /></template>
                Driving
              </AppTag>
            </div>
            <div class="ds-list-row">
